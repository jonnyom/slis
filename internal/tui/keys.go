...
var browserBindings = []Binding{
	...
	{[]string{"i"}, "import discovered candidate worktrees (opt-in ingestion overlay)"},
	...
	{[]string{"o", "e"}, "open the whole slice in your editor (all repos, one window)"},
...
var cockpitBindings = []Binding{
	...
	{[]string{"b"}, "cycle diff scope: working branch → vs parent → vs trunk"},
